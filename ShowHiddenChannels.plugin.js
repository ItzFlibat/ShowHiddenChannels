 ...
 * @version 0.2.8
 * @author ItzFlibat (Flibat's Universe)
 * @authorId 619203349954166804
 * @source https://github.com/ItzFlibat/ShowHiddenChannels
 * @website https://dsc.gg/ItzFlibat
 * @description BetterDiscord plugin reveals inaccessible hidden channels, providing names, descriptions & access permissions for a better understanding of the server's structure.
*/
...
const config = {
    info: {
      name: "ShowHiddenChannels",
      authors: [{
        name: "ItzFlibat (Flibat's Universe)",
      }],
      description: "BetterDiscord plugin reveals inaccessible hidden channels, providing names, descriptions & access permissions for a better understanding of the server's structure.",
      version: "0.2.8",
      github: "https://github.com/ItzFlibat/ShowHiddenChannels",
      github_raw: "https://raw.githubusercontent.com/ItzFlibat/ShowHiddenChannels/main/ShowHiddenChannels.plugin.js"
    },
