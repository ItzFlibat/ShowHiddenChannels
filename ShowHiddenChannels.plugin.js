...
(() => { // webpackBootstrap
	...
	var __webpack_modules__ = ({
		...
		"./src/components/HiddenChannelIcon.jsx":
			...
			((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				function HiddenChannelComponent({
					...
					})), icon == 'lock' && BdApi.React.createElement("svg", {
						className: actionIcon,
						viewBox: "0 0 24 24"
					}, BdApi.React.createElement("path", {
						fill: "currentColor",
		...
		"./src/components/Lockscreen.jsx":
			...
			((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				/* harmony import */
				var _UserMentionsComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! ./UserMentionsComponent */ "./src/components/UserMentionsComponent.jsx");
				/* harmony import */
				var _ChannelRolesComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! ./ChannelRolesComponent */ "./src/components/ChannelRolesComponent.jsx");
				/* harmony import */
				var _AdminRolesComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! ./AdminRolesComponent */ "./src/components/AdminRolesComponent.jsx");
				/* harmony import */
				var _ForumComponent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__( /*! ./ForumComponent */ "./src/components/ForumComponent.jsx");
				/* harmony import */
				var _utils_date__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! ../utils/date */ "./src/utils/date.js");
				const React = BdApi.React;
				...
				const Lockscreen = React.memo(({
					...
					return BdApi.React.createElement("div", {
						...
						src: settings['hiddenChannelIcon'] == 'lock' ? 'https://discord.com/assets/433e3ec4319a9d11b0cbe39342614982.svg': 'https://discord.com/assets/433e3ec4319a9d11b0cbe39342614982.svg'
	...
	(() => {
		...
		/* harmony import */
		var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! ./styles.css */ "./src/styles.css");
		...
		const __WEBPACK_DEFAULT_EXPORT__ = (!global.ZeresPluginLibrary ?
			...
			(([Pl, Lib]) => {
				const plugin = (Plugin, Library) => {
					...
					const {
						Lockscreen
					} = __webpack_require__( /*! ./components/Lockscreen */ "./src/components/Lockscreen.jsx");
					const {
						HiddenChannelIcon
					} = __webpack_require__( /*! ./components/HiddenChannelIcon */ "./src/components/HiddenChannelIcon.jsx");
					...
					return class ShowHiddenChannels extends Plugin {
						...
						getSettingsPanel() {
							const {
								IconSwitchWrapper
							} = __webpack_require__( /*! ./components/IconSwitchWrapper */ "./src/components/IconSwitchWrapper.jsx");
									...
									...Object.values(GuildStore.getGuilds()).map(
										...
										new IconSwitch(
											...
											(e) => {
												...
												icon: ImageResolver.getGuildIconURL(guild) ??
